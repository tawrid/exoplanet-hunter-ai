...
print(f"TESS Test Accuracy: {acc:.4f}")
print("TESS Classification Report:")
print(classification_report(y_test, y_pred, target_names=le.classes_))

# Save model, label encoder, and scaler in ./models directory
dump(model, './models/tess_model.joblib')
dump(le, './models/tess_label_encoder.joblib')
dump(scaler, './models/tess_scaler.joblib')
print("TESS model, label encoder, and scaler saved in ./models/")
